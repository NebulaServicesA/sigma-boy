...
const unblockerText = "Adrian Joseph Unblocker"; // Updated text
document.getElementById('unblocker').innerText = unblockerText; // Assuming there's an element with this ID
